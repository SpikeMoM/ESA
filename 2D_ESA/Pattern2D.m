...
array_params.flag.gain=1;%0 = Don't Compute Gain, 1=Compute Gain
...
array_params.tilt.angle=0;%degrees
...
if array_params.flag.wgt==0 % 口面等幅/不等幅激励
...
if array_params.flag.error_rand==0 % 是否在等幅馈电基础上引入幅度相位激励误差
...
if array_params.tilt.option == 0 % 好像是笛卡尔天线主平面旋转变换，原点不变？
...
if plotcommand.coord==0 % 天线坐标系与雷达坐标系转换
...
if array_params.flag.gain==1 % 理想增益由口径计算，实际增益由计算得出
